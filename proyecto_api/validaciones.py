...
def es_refugio(datos :dict) -> bool:
    ...
    """
    try:
        return es_varchar(datos['nombre'], 64) and es_varchar(datos['direccion'], 100) and es_float(datos['coordx']) and es_float(datos['coordy']) and es_telefono(datos['telefono'])
    except KeyError:
        return False
